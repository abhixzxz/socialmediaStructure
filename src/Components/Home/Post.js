...
const Post = ({ post, posts, setPosts, setFriendsProfile, images }) => {
  const [comments, setComments] = useState([
    {
      ...
      time: "3 Hours Ago",
      comment:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse asperiores debitis saepe itaque, eligendi quasi laboriosam vitae voluptatem animi maiores voluptatibus.",
    },
    {
      id: 2,
      profilePic: img2,
    ...
    },
    {
      ...
      time: "30 Mins Ago",
      comment:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse asperiores debitis saepe itaque, eligendi quasi",
    },
  ]);
  ...
  // State for managing the like animation
    ...
    <div className="post">
      ...
      {post.img && (
        <div className="post-img-container" onDoubleClick={handleDoubleClick}>
          ...
          {showLikeAnimation && (
            <FavoriteRoundedIcon className="animated-like" />
          )}
        </div>
      )}
